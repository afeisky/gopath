...
func Syncdb() {
	...
	force := true
	// 打印执行过程
	verbose := false // true  //wuchaofei modify
	// 遇到错误立即返回
...
func insertCompany() {
	...
	g.Status = 2
	o.Insert(g)
	fmt.Println("insert company end")
}
func insertProductUser() {
	...
	u.Email = "afeisky@163.com"
	u.Remark = "user1"
	u.Status = 2
	o = orm.NewOrm()
	o.Insert(u)
	fmt.Println("insert productuser end")
}
...
func insertNodes() {
	...
	nodes := [43]Node{
		...
		//BEGIN-wuchaofei add
		{Name: "app1", Title: "APP1", Remark: "", Level: 1, Pid: 0, Status: 2, Group: g}, // line 25
			{Name: "company/index", Title: "App1Company", Remark: "", Level: 2, Pid: 25, Status: 2, Group: g}, // line 26
				{Name: "index", Title: "company list", Remark: "", Level: 3, Pid: 26, Status: 2, Group: g},
				{Name: "AddCompany", Title: "add company", Remark: "", Level: 3, Pid: 26, Status: 2, Group: g},
				{Name: "UpdateCompany", Title: "update company", Remark: "", Level: 3, Pid: 26, Status: 2, Group: g},
				{Name: "DelCompany", Title: "del company", Remark: "", Level: 3, Pid: 26, Status: 2, Group: g},
			{Name: "user/index", Title: "App1User", Remark: "", Level: 2, Pid: 25, Status: 2, Group: g}, // line 31
				{Name: "Index", Title: "user list", Remark: "", Level: 2, Pid: 31, Status: 2, Group: g},
				{Name: "AddUser", Title: "add user", Remark: "", Level: 3, Pid: 31, Status: 2, Group: g},
				{Name: "UpdateUser", Title: "update user", Remark: "", Level: 3, Pid: 31, Status: 2, Group: g},
				{Name: "DelUser", Title: "del user", Remark: "", Level: 3, Pid: 31, Status: 2, Group: g},
				{Name: "UserSelectCompanyList", Title: "show User to companylist", Remark: "", Level: 3, Pid: 31, Status: 2, Group: g},
				{Name: "UserUpdateCompany", Title: "update company id", Remark: "", Level: 3, Pid: 31, Status: 2, Group: g},
			{Name: "client/index", Title: "App1Client", Remark: "", Level: 2, Pid: 25, Status: 2, Group: g}, // line 39
				{Name: "Index", Title: "client list", Remark: "", Level: 2, Pid: 39, Status: 2, Group: g},
				{Name: "AddClient", Title: "add client", Remark: "", Level: 3, Pid: 39, Status: 2, Group: g},
				{Name: "UpdateClient", Title: "update client", Remark: "", Level: 3, Pid: 39, Status: 2, Group: g},
				{Name: "DelClient", Title: "del client", Remark: "", Level: 3, Pid: 39, Status: 2, Group: g},
			{Name: "data", Title: "App1data", Remark: "数据接口", Level: 2, Pid: 25, Status: 2, Group: g},
		//END---wuchaofei ad
	}
	for _, v := range nodes {
		n := new(Node)
