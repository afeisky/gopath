...
$(function(){
    ...
    $("#datagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'Name',title:'公司名',width:100,align:'center',editor:'text'},
            {field:'Longname',title:'全称',width:100,align:'center',editor:'text'},
        ...
        onAfterEdit:function(index, data, changes){
            ...
            changes.Id = data.Id;
            vac.ajax(URL+'/UpdateCompany', changes, 'POST', function(r){
                if(!r.status){
                    vac.alert(r.info);
                }else{
...
function delrow(){
    $.messager.confirm('Confirm','你确定要删除?',function(r){
        if (r){
            ...
            vac.ajax(URL+'/DelCompany', {Id:row.Id}, 'POST', function(r){
                if(r.status){
                    $("#datagrid").datagrid('reload');
                }else{
                    vac.alert(r.info);
